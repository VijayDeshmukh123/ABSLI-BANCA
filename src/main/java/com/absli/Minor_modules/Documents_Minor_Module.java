...
public class Documents_Minor_Module {
	Dashboard dashboard;
	WaitUtils wait;
	LoginPage loginPage;
...
//------------------------------------------------------Same GMS------------------------------------------------------------------//
	...
	public void Documents_Minor_module(WebDriver driver, HashMap<String, String> testData)
	...
	for (int i = 0; i < docSize; i++) {
		...
		if (str.equalsIgnoreCase("Address Proof")) {
			if (testData.get("IsAadhaarCard").equalsIgnoreCase("NO") || testData.get("PanNameEdit").equalsIgnoreCase("YES") || testData.get("EditAddress").equalsIgnoreCase("YES")) {
				if (testData.get("IsPanAvailable").equalsIgnoreCase("NO") || testData.get("PanNameEdit").equalsIgnoreCase("YES") || testData.get("EditAddress").equalsIgnoreCase("YES") || testData.get("PanDOBEdit").equalsIgnoreCase("YES")) {
					...
					if (testData.get("IsPanAvailable").equalsIgnoreCase("YES") && testData.get("IsNRI").equalsIgnoreCase("NO")
