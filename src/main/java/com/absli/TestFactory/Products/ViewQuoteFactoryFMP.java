...
public class ViewQuoteFactoryFMP {
	...
	public void ViewPageFMP(WebDriver driver, HashMap<String, String> testData) throws InterruptedException, IOException {
		...
		String SumAssuredValue = getDriver().findElement(By.xpath("(//p[@id='Initial-premium-amount'])[3]"))
				.getText();
		...
		WebElement PlanOpt = getDriver().findElement(By.xpath("(//div[contains(@class,'quote-plan-option')])[1]"));
		String PlanOptionValue = PlanOpt.getText();
		softassert.assertEquals(PlanOptionValue, "PlanOption");
